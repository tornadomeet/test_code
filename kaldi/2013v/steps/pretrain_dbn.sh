...
copy_feats=false    # resave the features randomized consecutively to tmpdir
# feature config
...
#/styx/home/hzchenhaibo/sourcecode/kaldi-trunk-fast/src/nnetbin/rbm-train-cd1-frmshuff --learn-rate=$rbm_lrate_low --l2-penalty=$rbm_l2penalty \
...
#/styx/home/hzchenhaibo/sourcecode/kaldi-trunk-fast/src/nnetbin/rbm-train-cd1-frmshuff --learn-rate=$rbm_lrate --l2-penalty=$rbm_l2penalty \
