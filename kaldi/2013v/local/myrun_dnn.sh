...
steps/make_fmllr_feats.sh --nj 10 \
...
#$cuda_cmd $dir/_pretrain_dbn.log \
  steps/pretrain_dbn.sh --hid-dim 2048 --rbm-iter 2 data-fmllr-tri3b/train $dir || exit 1;
}
...
steps/decode_nnet.sh --nj 20 --config conf/decode_dnn.config --acwt 0.1 \
  exp/tri2b/graph data-fmllr-tri3b/test $dir/decode || exit 1;
}
...
srcdir=exp/tri3b_pretrain-dbn_dnn_it20
acwt=0.1
...
for ITER in 1 2 3 4 5 6; do
  ...
  steps/decode_nnet.sh --nj 20 --cmd "$decode_cmd" --config conf/decode_dnn.config \
    ...
    exp/tri2b/graph data-fmllr-tri3b/test $dir/decode_it${ITER} || exit 1
done 
}
...
#for ITER in 1 2 3; do
  # decode
  ITER=4
  steps/decode_nnet_fast.sh --nj 20 --cmd "$decode_cmd" --config conf/decode_dnn.config \
    --nnet $dir/${ITER}.nnet --acwt $acwt \
    exp/tri2b/graph data-fmllr-tri3b/test $dir/decode_it${ITER} || exit 1
#done 
}
