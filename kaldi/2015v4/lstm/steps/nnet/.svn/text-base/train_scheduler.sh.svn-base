...
# because lstm is easy to divergency,so we'll havling lr every iter
start_halving_impr=0.99 # the original value is 0.01,but it is easy to overfitting, so we use larger value here
end_halving_impr=0.002
halving_factor=0.5
# misc.
verbose=1
# tool
